...
struct GfwTutorial {
  ...
  void init(InitContext const&)
  {
    ...
    fGFW->AddRegion("refN04", -0.8, -0.2, 1, 1);
    fGFW->AddRegion("refP04", 0.2, 0.8, 1, 1);
    fGFW->AddRegion("refN06", -0.8, -0.3, 1, 1);
    fGFW->AddRegion("refP06", 0.3, 0.8, 1, 1);
  ...
  void process(aodCollisions::iterator const& collision, aod::BCsWithTimestamps const&, aodTracks const& tracks)
  {
    ...
    FillProfile(corrconfigs.at(1), HIST("c22_gap04"), cent);
    FillProfile(corrconfigs.at(2), HIST("c22_gap06"), cent);
    FillProfile(corrconfigs.at(3), HIST("c22_gap08"), cent);
    FillProfile(corrconfigs.at(4), HIST("c22_gap10"), cent);
  }
};
